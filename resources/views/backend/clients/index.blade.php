...
@section('contentheader_title')
    ...
    @if (has_permission('clients.write'))
        {!! link_to_route('backend.clients.create', trans('motor-backend::backend/clients.new'), [], ['class' => 'pull-right float-right btn btn-sm btn-success']) !!}
    @endif
@endsection
